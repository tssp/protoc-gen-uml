...
package object formatter {
  ...
  case class StructuredStringFormatter(lines: Seq[String], level: Int) {
    ...
    def withIfElse(condition: Boolean)(ifFormatter: StructuredStringFormatter => StructuredStringFormatter, elseFormatter: StructuredStringFormatter => StructuredStringFormatter) =
